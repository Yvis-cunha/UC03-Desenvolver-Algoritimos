...
switch(escolha){
    ...
    case '2':
        ...
        gerente1.salario = prompt("Salario: ")
        gerente1.matricula = prompt("Matricula: ")
        gerente1.setor = prompt("Setor: ")
        gerente1.quantidadeequipe = prompt("Qtd Equipe: ")
    ...
    case '3':
        ...
        diretor1.salario = prompt("Salario: ")
        ...
        diretor1.tempodirecao = prompt("Tempo de direção: ")
    ...
    case '4':
        ...
        dono1.patrimonio = prompt("Patrimonio: ")
